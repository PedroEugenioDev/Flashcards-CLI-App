...
export declare type Base16Number = NumberRange<256>;
export declare type BinaryNumber = number;
export declare type PercentageNumber = NumberRange<101>;
export declare type GradientNumber = NumberRange<361>;
...
export declare function instanceOfHSV(obj: any): obj is HSV;
export declare function instanceOfHSVA(obj: any): obj is HSVA;
...
export declare type COLOR = RGB | RGBA | HSL | HSLA | HEX | HSV | HSVA | CMYK;
