...
exports.toType = exports.toCMYK = exports.toRGBA = exports.toRGB = exports.toHSVA = exports.toHSV = exports.toHSLA = exports.toHSL = exports.toHex = void 0;
...
exports.toHSL = toHSL;
const toHSLA = (color) => {
    const hsla = (0, exports.toHSL)(color);
    const alpha = hsla.a > -1 ? hsla.a : 1;
    return Object.assign(Object.assign({}, hsla), { a: alpha });
};
...
exports.toHSV = toHSV;
const toHSVA = (color) => {
    const hsva = (0, exports.toHSV)(color);
    const alpha = hsva.a > -1 ? hsva.a : 1;
    return Object.assign(Object.assign({}, hsva), { a: alpha });
};
...
const toRGB = (color) => {
    if (typeof color == "string") {
        ...
        if ((0, is_1.isHSLA)(color))
            return (0, convert_1.hslToRgb)((0, object_1.toHslObject)(color));
        if ((0, is_1.isHSV)(color))
            return (0, convert_1.hsvToRgb)((0, object_1.toHsvObject)(color));
        if ((0, is_1.isHSVA)(color))
            return (0, convert_1.hsvToRgb)((0, object_1.toHsvObject)(color));
        if ((0, is_1.isCMYK)(color))
...
exports.toRGB = toRGB;
const toRGBA = (color) => {
    const rgba = (0, exports.toRGB)(color);
    const alpha = rgba.a > -1 ? rgba.a : 1;
    return Object.assign(Object.assign({}, rgba), { a: alpha });
};
